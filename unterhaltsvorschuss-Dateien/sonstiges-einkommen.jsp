...
<% pageProcessor.createSyncPoint("sonstiges-einkommen"); %>
<% ((java.util.Set)session.getAttribute("composer.visitedPages")).add("sonstiges-einkommen"); %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cit="http://www.cit.de/ns/jsp" xmlns:html="http://www.w3.org/1999/xhtml" lang="de-DE" class="no-js">
   <head>
    ...
    <cit:theme/>
      ...
      <title id="page-title">
         <cit:conditional test="!assistants.request.valid">Fehler beim Ausfüllen - </cit:conditional>unterhaltsvorschuss - Sonstiges Einkommen</title>
      <cit:control>
         <cit:link rel="helpbase" href="help.jsp"/>
         <cit:flow/>
      </cit:control>
   </head>
   <body id="sonstiges-einkommen">
      <div id="custom_top"/>
      <div id="if">
         <div id="page" class=" has_roadmap_right">
            ...
            <nav id="roadmap" class="roadmap roadmap_right">
               ...
               <ul class="icons"><% final boolean unvisited_d42e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d42e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                     ...
                     </span><% } %></li><% final boolean unvisited_d42e16 = !isVisited(session, "sonstiges-einkommen"); %><li class='present<%= unvisited_d42e16 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                           <span class="labeltext">Sonstiges Einkommen</span>
                  ...
                  <section id="content" class=" narrow">
                     <cit:form beanName="myForm">
                        <div class="wizard-body">
                           <h2 id="title">Sonstiges Einkommen</h2>
                           ...
                           <section class="block live narrow label_after" data-comments='<%= getComments(pageContext.getAttribute("form"), "einkommenausnebentaetigkeit") %>' data-live-stay="stay_nonval_d0e1774">
                              ...
                              <cit:inputSubmit type="stay.nonval.d0e1774" id="stay.nonval.d0e1774" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                              <script type="text/javascript">document.getElementById('stay_nonval_d0e1774').style.display='none';</script>
                           ...
                           <section class="block live narrow label_after" data-comments='<%= getComments(pageContext.getAttribute("form"), "einkommenausvermietung") %>' data-live-stay="stay_nonval_d0e1792">
                              ...
                              <cit:inputSubmit type="stay.nonval.d0e1792" id="stay.nonval.d0e1792" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                              <script type="text/javascript">document.getElementById('stay_nonval_d0e1792').style.display='none';</script>
                        ...
                        <nav id="roadmap_bottom" class="roadmap">
                           ...
                           <ul class="icons"><% final boolean unvisited_d44e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d44e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d44e16 = !isVisited(session, "sonstiges-einkommen"); %><li class='present<%= unvisited_d44e16 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Sonstiges Einkommen</span>
