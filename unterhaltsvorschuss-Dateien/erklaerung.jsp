...
<% pageProcessor.createSyncPoint("erklaerung"); %>
<% ((java.util.Set)session.getAttribute("composer.visitedPages")).add("erklaerung"); %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cit="http://www.cit.de/ns/jsp" xmlns:html="http://www.w3.org/1999/xhtml" lang="de-DE" class="no-js">
   <head>
    ...
    <cit:theme/>
      ...
      <title id="page-title">
         <cit:conditional test="!assistants.request.valid">Fehler beim Ausfüllen - </cit:conditional>unterhaltsvorschuss - Erklärung</title>
      <cit:control>
         ...
         <div id="page" class=" has_roadmap_right">
            ...
            <nav id="roadmap" class="roadmap roadmap_right">
               ...
               <ul class="icons"><% final boolean unvisited_d45e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d45e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                     ...
                     </span><% } %></li><% final boolean unvisited_d45e14 = !isVisited(session, "erklaerung"); %><li class='present<%= unvisited_d45e14 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d45e16 = !isVisited(session, "vormundschaft-beistandschaft-rechtsbeistand"); %><li class='future<%= unvisited_d45e16 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d45e18 = !isVisited(session, "angaben-anderes-elternteil"); %><li class='future<%= unvisited_d45e18 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d45e20 = !isVisited(session, "weitere-angaben-zum-anderen-elternteil"); %><li class='future<%= unvisited_d45e20 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d45e22 = !isVisited(session, "angaben-zum-unterhalt"); %><li class='future<%= unvisited_d45e22 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d45e24 = !isVisited(session, "angaben-zu-weiteren-gemeinsamen-kindern-des-antragstellers-der-antragstellerin"); %><li class='future<%= unvisited_d45e24 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d45e26 = !isVisited(session, "hinweise"); %><li class='future<%= unvisited_d45e26 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  <section id="content" class=" narrow">
                     <cit:form beanName="myForm">
                        <div class="wizard-body">
                           ...
                           <header class="intro">Ich versichere, dass ich die oben genannten Angaben nach bestem Wissen und Gewissen ausgefüllt und alle Angaben vollständig gemacht habe. Für die Leistungen nach dem UVG werden die angegebenen persönlichen Daten elektronisch gespeichert und verarbeitet. Eine Übermittlung der Angaben aus dem Antrag erfolgt nur an die Stellen, die sie zur Erfüllung ihrer Aufgaben benötigen und die zur Auskunft berechtigt sind.</header>
                           <section class="block narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "einwilligungdatenaustausch") %>'>
                              ...
                              <div class="formline">
                                 <div class="inputcontainer">
                                    <cit:inputBoolean name="einwilligungdatenaustausch"/>
                                 </div>
                                 <cit:inputLabel name="einwilligungdatenaustausch">Ich bin damit einverstanden, dass die notwendigen Daten zur Durchführung des UVG mit dem Beistand, dem (Amts-)Pfleger oder dem Vormund ausgetauscht werden können. Die erteilte Einwilligung ist freiwillig und kann jederzeit widerrufen werden. Bis zum Widerruf bleibt die Rechtmäßigkeit der Verarbeitung auf der Grundlage der Einwilligung unberührt.</cit:inputLabel>
                              </div>
                           </section>
                        </div>
                        <nav id="roadmap_bottom" class="roadmap">
                           ...
                           <ul class="icons"><% final boolean unvisited_d48e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d48e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d48e14 = !isVisited(session, "erklaerung"); %><li class='present<%= unvisited_d48e14 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Erklärung</span>
                              ...
                              </li><% final boolean unvisited_d48e16 = !isVisited(session, "vormundschaft-beistandschaft-rechtsbeistand"); %><li class='future<%= unvisited_d48e16 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Vormundschaft / Beistandschaft / Rechtsbeistand</span>
                              ...
                              </li><% final boolean unvisited_d48e18 = !isVisited(session, "angaben-anderes-elternteil"); %><li class='future<%= unvisited_d48e18 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben anderes Elternteil</span>
                              ...
                              </li><% final boolean unvisited_d48e20 = !isVisited(session, "weitere-angaben-zum-anderen-elternteil"); %><li class='future<%= unvisited_d48e20 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Weitere Angaben zum anderen Elternteil</span>
