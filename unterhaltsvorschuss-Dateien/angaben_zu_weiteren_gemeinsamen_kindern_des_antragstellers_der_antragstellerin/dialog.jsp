...
<% pageProcessor.createSyncPoint("angaben_zu_weiteren_gemeinsamen_kindern_des_antragstellers_der_antragstellerin--angaben-zu-weiteren-gemeinsamen-kindern-des-antragstellers-der-antragstellerin"); %>
<% ((java.util.Set)session.getAttribute("composer.visitedPages")).add("angaben_zu_weiteren_gemeinsamen_kindern_des_antragstellers_der_antragstellerin--angaben-zu-weiteren-gemeinsamen-kindern-des-antragstellers-der-antragstellerin"); %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cit="http://www.cit.de/ns/jsp" xmlns:html="http://www.w3.org/1999/xhtml" lang="de-DE" class="no-js">
   ...
   <body id="angaben_zu_weiteren_gemeinsamen_kindern_des_antragstellers_der_antragstellerin--angaben-zu-weiteren-gemeinsamen-kindern-des-antragstellers-der-antragstellerin">
      <div id="custom_top"/>
      <div id="if">
         <div id="page" class=" has_roadmap_right">
            ...
            <nav id="roadmap" class="roadmap roadmap_right">
               ...
               <ul class="icons"><% final boolean unvisited_d52e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d52e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                     ...
                     </span><% } %></li><% final boolean unvisited_d52e4 = !isVisited(session, "angaben-zum-antragsteller"); %><li class='past<%= unvisited_d52e4 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-zum-antragsteller") != null) { %><span class="item clickable" data-submit-value="resync.angaben-zum-antragsteller">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d52e6 = !isVisited(session, "letzter-bezirk-und-ortsteil-in-berlin"); %><li class='past<%= unvisited_d52e6 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("letzter-bezirk-und-ortsteil-in-berlin") != null) { %><span class="item clickable" data-submit-value="resync.letzter-bezirk-und-ortsteil-in-berlin">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d52e8 = !isVisited(session, "familienstand"); %><li class='past<%= unvisited_d52e8 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("familienstand") != null) { %><span class="item clickable" data-submit-value="resync.familienstand">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d52e12 = !isVisited(session, "vormundschaft-beistandschaft-rechtsbeistand"); %><li class='past<%= unvisited_d52e12 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("vormundschaft-beistandschaft-rechtsbeistand") != null) { %><span class="item clickable" data-submit-value="resync.vormundschaft-beistandschaft-rechtsbeistand">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d52e14 = !isVisited(session, "angaben-anderes-elternteil"); %><li class='past<%= unvisited_d52e14 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-anderes-elternteil") != null) { %><span class="item clickable" data-submit-value="resync.angaben-anderes-elternteil">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d52e16 = !isVisited(session, "angaben-zum-unterhalt"); %><li class='past<%= unvisited_d52e16 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-zum-unterhalt") != null) { %><span class="item clickable" data-submit-value="resync.angaben-zum-unterhalt">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d52e18 = !isVisited(session, "angaben_zu_weiteren_gemeinsamen_kindern_des_antragstellers_der_antragstellerin"); %><li class='present-perfect<%= unvisited_d52e18 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben_zu_weiteren_gemeinsamen_kindern_des_antragstellers_der_antragstellerin") != null) { %><span class="item clickable" data-submit-value="resync.angaben_zu_weiteren_gemeinsamen_kindern_des_antragstellers_der_antragstellerin">
                        <a href="" class="label">
                           <span class="labeltext">Angaben zu weiteren (gemeinsamen) Kindern des Antragstellers / der Antragstellerin</span>
                           <span class="labelicon" title='<%= unvisited_d52e18 ? "Zurückliegende Seite (nicht besucht)" : "Zurückliegende Seite" %>'>
                              <span class="accessibility"><%= unvisited_d52e18 ? "Zurückliegende Seite (nicht besucht)" : "Zurückliegende Seite" %></span>
                           </span>
                        </a>
                     </span><% } else { %><span class="item">
                        <span class="label">
                     ...
                     </span><% } %><ul class="icons"><% final boolean unvisited_d52e21 = false; %><li class='present<%= unvisited_d52e21 ? " unvisited" : "" %>'>
                           <span class="item">
                              <span class="label">
                                 <span class="labeltext">Angaben zu weiteren (gemeinsamen) Kindern des Antragstellers / der Antragstellerin</span>
                                 <span class="labelicon" title='<%= unvisited_d52e21 ? "Aktuelle Seite (nicht besucht)" : "Aktuelle Seite" %>'>
                                    <span class="accessibility"><%= unvisited_d52e21 ? "Aktuelle Seite (nicht besucht)" : "Aktuelle Seite" %></span>
                                 </span>
                              </span>
                           </span>
                        </li>
                     ...
                     <cit:form beanName="myForm">
                        ...
                        <nav id="roadmap_bottom" class="roadmap">
                           ...
                           <ul class="icons"><% final boolean unvisited_d54e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d54e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d54e18 = !isVisited(session, "angaben_zu_weiteren_gemeinsamen_kindern_des_antragstellers_der_antragstellerin"); %><li class='present-perfect<%= unvisited_d54e18 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben_zu_weiteren_gemeinsamen_kindern_des_antragstellers_der_antragstellerin") != null) { %><span class="item clickable" data-submit-value="resync.angaben_zu_weiteren_gemeinsamen_kindern_des_antragstellers_der_antragstellerin">
                                    <a href="" class="label">
                                       <span class="labeltext">Angaben zu weiteren (gemeinsamen) Kindern des Antragstellers / der Antragstellerin</span>
                                 ...
                                 </span><% } %><ul class="icons"><% final boolean unvisited_d54e21 = false; %><li class='present<%= unvisited_d54e21 ? " unvisited" : "" %>'>
                                       <span class="item">
                                          <span class="label">
                                             <span class="labeltext">Angaben zu weiteren (gemeinsamen) Kindern des Antragstellers / der Antragstellerin</span>
                                             <span class="labelicon" title='<%= unvisited_d54e21 ? "Aktuelle Seite (nicht besucht)" : "Aktuelle Seite" %>'>
                                                <span class="accessibility"><%= unvisited_d54e21 ? "Aktuelle Seite (nicht besucht)" : "Aktuelle Seite" %></span>
                                             </span>
                                          </span>
                                       </span>
                                    </li>
