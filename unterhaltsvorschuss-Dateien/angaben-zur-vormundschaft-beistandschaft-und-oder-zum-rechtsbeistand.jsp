...
<% pageProcessor.createSyncPoint("angaben-zur-vormundschaft-beistandschaft-und-oder-zum-rechtsbeistand"); %>
<% ((java.util.Set)session.getAttribute("composer.visitedPages")).add("angaben-zur-vormundschaft-beistandschaft-und-oder-zum-rechtsbeistand"); %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cit="http://www.cit.de/ns/jsp" xmlns:html="http://www.w3.org/1999/xhtml" lang="de-DE" class="no-js">
  ...
  <!--plugin:ui-rbs2-->
      ...
      <title id="page-title">
         <cit:conditional test="!assistants.request.valid">Fehler beim Ausfüllen - </cit:conditional>unterhaltsvorschuss - Angaben zur Vormundschaft, Beistandschaft und/oder zum Rechtsbeistand</title>
      <cit:control>
         <cit:link rel="helpbase" href="help.jsp"/>
         <cit:flow/>
         <cit:page-validation id="d0e1723-required" test="!My.empty(myForm.beistandschaft)"/>
         <cit:page-validation id="d0e1771-required" test="!(myForm.beistandschaft == true) || !My.empty(myForm.beistandauskunftserteilung)"/>
         <cit:page-validation id="d0e1780-required" test="!My.empty(myForm.beauftragungrechtsanwaltsbuero)"/>
      </cit:control>
   </head>
   <body id="angaben-zur-vormundschaft-beistandschaft-und-oder-zum-rechtsbeistand">
      <div id="custom_top"/>
      <div id="if">
         <div id="page" class=" has_roadmap_right">
            ...
            <nav id="roadmap" class="roadmap roadmap_right">
               ...
               <ul class="icons"><% final boolean unvisited_d44e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d44e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                     ...
                     </span><% } %></li><% final boolean unvisited_d44e14 = !isVisited(session, "angaben-zur-vormundschaft-beistandschaft-und-oder-zum-rechtsbeistand"); %><li class='present<%= unvisited_d44e14 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                           <span class="labeltext">Angaben zur Vormundschaft, Beistandschaft und/oder zum Rechtsbeistand</span>
                  ...
                  <section id="content" class=" narrow">
                     <cit:form beanName="myForm">
                        <div class="wizard-body">
                           <h2 id="title">Angaben zur Vormundschaft, Beistandschaft und/oder zum Rechtsbeistand</h2>
                           ...
                           <section class="block live narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "beistandschaft") %>' data-live-stay="stay_nonval_d0e1723">
                              ...
                              <cit:validationMessage for="d0e1723-required">
                                 <cit:conditional test="assistants.request.isValid('beistandschaft')">
                                    <p class="errorText">
                              ...
                              <cit:inputSubmit type="stay.nonval.d0e1723" id="stay.nonval.d0e1723" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                              <script type="text/javascript">document.getElementById('stay_nonval_d0e1723').style.display='none';</script>
                           ...
                           <cit:conditional test="myForm.beistandschaft == true">
                              <section class="block narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "beistandauskunftserteilung") %>'>
                                 ...
                                 <cit:validationMessage for="d0e1771-required">
                                    <cit:conditional test="assistants.request.isValid('beistandauskunftserteilung')">
                                       <p class="errorText">
                                          <strong>Bitte wählen Sie einen Wert aus.</strong>
                                       </p>
                           ...
                           <section class="block live narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "beauftragungrechtsanwaltsbuero") %>' data-live-stay="stay_nonval_d0e1780">
                              ...
                              <cit:validationMessage for="d0e1780-required">
                                 <cit:conditional test="assistants.request.isValid('beauftragungrechtsanwaltsbuero')">
                                    <p class="errorText">
                                       <strong>Bitte wählen Sie einen Wert aus.</strong>
                                    </p>
                              ...
                              <cit:inputSubmit type="stay.nonval.d0e1780" id="stay.nonval.d0e1780" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                              <script type="text/javascript">document.getElementById('stay_nonval_d0e1780').style.display='none';</script>
                        ...
                        <nav id="roadmap_bottom" class="roadmap">
                           ...
                           <ul class="icons"><% final boolean unvisited_d46e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d46e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d46e14 = !isVisited(session, "angaben-zur-vormundschaft-beistandschaft-und-oder-zum-rechtsbeistand"); %><li class='present<%= unvisited_d46e14 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben zur Vormundschaft, Beistandschaft und/oder zum Rechtsbeistand</span>
