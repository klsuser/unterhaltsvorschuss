...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cit="http://www.cit.de/ns/jsp" xmlns:html="http://www.w3.org/1999/xhtml">
   <head>
    ...
    <cit:theme/>
      ...
      <title>unterhaltsvorschuss - Abschluss Eintrag Weitere (gemeinsame) Kinder</title>
      <cit:control/>
   </head>
   <body>
            ...
            <div id="main" class="clearing">
               <div id="center">
                  <div id="wizard" class="clearing">
                     <div id="wizard-body">
                        <h2 id="title">Abschluss Eintrag Weitere (gemeinsame) Kinder</h2>
                        ...
                        <div class="roadmap">
                           <ul>
                              ...
                              <li class="present">
                                 <p>
                                    <span class="indicator">»</span>
                                    <span class="item">Weitere (gemeinsame) Kinder</span>
                                 </p>
                                 <ul class="collapsed">
                                    <li class="future">
                                       <p>
