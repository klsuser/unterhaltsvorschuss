...
<% pageProcessor.createSyncPoint("weitere_gemeinsame_kinder--weitere-gemeinsame-kinder"); %>
<% ((java.util.Set)session.getAttribute("composer.visitedPages")).add("weitere_gemeinsame_kinder--weitere-gemeinsame-kinder"); %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cit="http://www.cit.de/ns/jsp" xmlns:html="http://www.w3.org/1999/xhtml" lang="de-DE" class="no-js">
   ...
   <body id="weitere_gemeinsame_kinder--weitere-gemeinsame-kinder">
      <div id="custom_top"/>
      <div id="if">
         <div id="page" class=" has_roadmap_right">
            ...
            <nav id="roadmap" class="roadmap roadmap_right">
               ...
               <ul class="icons"><% final boolean unvisited_d56e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d56e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                     ...
                     </span><% } %></li><% final boolean unvisited_d56e4 = !isVisited(session, "angaben-zum-antragsteller"); %><li class='past<%= unvisited_d56e4 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-zum-antragsteller") != null) { %><span class="item clickable" data-submit-value="resync.angaben-zum-antragsteller">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d56e6 = !isVisited(session, "letzter-bezirk-und-ortsteil-in-berlin"); %><li class='past<%= unvisited_d56e6 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("letzter-bezirk-und-ortsteil-in-berlin") != null) { %><span class="item clickable" data-submit-value="resync.letzter-bezirk-und-ortsteil-in-berlin">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d56e8 = !isVisited(session, "familienstand"); %><li class='past<%= unvisited_d56e8 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("familienstand") != null) { %><span class="item clickable" data-submit-value="resync.familienstand">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d56e14 = !isVisited(session, "angaben-anderes-elternteil"); %><li class='past<%= unvisited_d56e14 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-anderes-elternteil") != null) { %><span class="item clickable" data-submit-value="resync.angaben-anderes-elternteil">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d56e16 = !isVisited(session, "angaben-zum-unterhalt"); %><li class='past<%= unvisited_d56e16 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-zum-unterhalt") != null) { %><span class="item clickable" data-submit-value="resync.angaben-zum-unterhalt">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d56e18 = !isVisited(session, "angaben-zu-weiteren-gemeinsamen-kindern-des-antragstellers-der-antragstellerin"); %><li class='past<%= unvisited_d56e18 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-zu-weiteren-gemeinsamen-kindern-des-antragstellers-der-antragstellerin") != null) { %><span class="item clickable" data-submit-value="resync.angaben-zu-weiteren-gemeinsamen-kindern-des-antragstellers-der-antragstellerin">
                        <a href="" class="label">
                           <span class="labeltext">Angaben zu weiteren (gemeinsamen) Kindern des Antragstellers / der Antragstellerin</span>
                           <span class="labelicon" title='<%= unvisited_d56e18 ? "Zurückliegende Seite (nicht besucht)" : "Zurückliegende Seite" %>'>
                              <span class="accessibility"><%= unvisited_d56e18 ? "Zurückliegende Seite (nicht besucht)" : "Zurückliegende Seite" %></span>
                           </span>
                        </a>
                     </span><% } else { %><span class="item">
                        <span class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d56e20 = !isVisited(session, "weitere_gemeinsame_kinder"); %><li class='present-perfect<%= unvisited_d56e20 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("weitere_gemeinsame_kinder") != null) { %><span class="item clickable" data-submit-value="resync.weitere_gemeinsame_kinder">
                        <a href="" class="label">
                           <span class="labeltext">Weitere (gemeinsame) Kinder</span>
                           <span class="labelicon" title='<%= unvisited_d56e20 ? "Zurückliegende Seite (nicht besucht)" : "Zurückliegende Seite" %>'>
                              <span class="accessibility"><%= unvisited_d56e20 ? "Zurückliegende Seite (nicht besucht)" : "Zurückliegende Seite" %></span>
                           </span>
                        </a>
                     </span><% } else { %><span class="item">
                        <span class="label">
                     ...
                     </span><% } %><ul class="icons"><% final boolean unvisited_d56e23 = false; %><li class='present<%= unvisited_d56e23 ? " unvisited" : "" %>'>
                           <span class="item">
                              <span class="label">
                                 <span class="labeltext">Weitere (gemeinsame) Kinder</span>
                                 <span class="labelicon" title='<%= unvisited_d56e23 ? "Aktuelle Seite (nicht besucht)" : "Aktuelle Seite" %>'>
                                    <span class="accessibility"><%= unvisited_d56e23 ? "Aktuelle Seite (nicht besucht)" : "Aktuelle Seite" %></span>
                                 </span>
                              </span>
                           </span>
                        </li>
                     ...
                     <cit:form beanName="myForm">
                        ...
                        <nav id="roadmap_bottom" class="roadmap">
                           ...
                           <ul class="icons"><% final boolean unvisited_d58e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d58e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d58e4 = !isVisited(session, "angaben-zum-antragsteller"); %><li class='past<%= unvisited_d58e4 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-zum-antragsteller") != null) { %><span class="item clickable" data-submit-value="resync.angaben-zum-antragsteller">
                                    <a href="" class="label">
                                       <span class="labeltext">Angaben zum Antragsteller</span>
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d58e6 = !isVisited(session, "letzter-bezirk-und-ortsteil-in-berlin"); %><li class='past<%= unvisited_d58e6 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("letzter-bezirk-und-ortsteil-in-berlin") != null) { %><span class="item clickable" data-submit-value="resync.letzter-bezirk-und-ortsteil-in-berlin">
                                    <a href="" class="label">
                                       <span class="labeltext">Letzter Bezirk und Ortsteil in Berlin</span>
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d58e8 = !isVisited(session, "familienstand"); %><li class='past<%= unvisited_d58e8 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("familienstand") != null) { %><span class="item clickable" data-submit-value="resync.familienstand">
                                    <a href="" class="label">
                                       <span class="labeltext">Familienstand</span>
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d58e10 = !isVisited(session, "angaben-zu-dem-kind-fuer-das-die-leistung-beantragt-wird"); %><li class='past<%= unvisited_d58e10 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-zu-dem-kind-fuer-das-die-leistung-beantragt-wird") != null) { %><span class="item clickable" data-submit-value="resync.angaben-zu-dem-kind-fuer-das-die-leistung-beantragt-wird">
                                    <a href="" class="label">
                                       <span class="labeltext">Angaben zu dem Kind, für das die Leistung beantragt wird</span>
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d58e12 = !isVisited(session, "vormundschaft-beistandschaft-rechtsbeistand"); %><li class='past<%= unvisited_d58e12 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("vormundschaft-beistandschaft-rechtsbeistand") != null) { %><span class="item clickable" data-submit-value="resync.vormundschaft-beistandschaft-rechtsbeistand">
                                    <a href="" class="label">
                                       <span class="labeltext">Vormundschaft / Beistandschaft / Rechtsbeistand</span>
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d58e14 = !isVisited(session, "angaben-anderes-elternteil"); %><li class='past<%= unvisited_d58e14 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-anderes-elternteil") != null) { %><span class="item clickable" data-submit-value="resync.angaben-anderes-elternteil">
                                    <a href="" class="label">
                                       <span class="labeltext">Angaben anderes Elternteil</span>
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d58e16 = !isVisited(session, "angaben-zum-unterhalt"); %><li class='past<%= unvisited_d58e16 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-zum-unterhalt") != null) { %><span class="item clickable" data-submit-value="resync.angaben-zum-unterhalt">
                                    <a href="" class="label">
                                       <span class="labeltext">Angaben zum Unterhalt</span>
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d58e18 = !isVisited(session, "angaben-zu-weiteren-gemeinsamen-kindern-des-antragstellers-der-antragstellerin"); %><li class='past<%= unvisited_d58e18 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-zu-weiteren-gemeinsamen-kindern-des-antragstellers-der-antragstellerin") != null) { %><span class="item clickable" data-submit-value="resync.angaben-zu-weiteren-gemeinsamen-kindern-des-antragstellers-der-antragstellerin">
                                    <a href="" class="label">
                                       <span class="labeltext">Angaben zu weiteren (gemeinsamen) Kindern des Antragstellers / der Antragstellerin</span>
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d58e20 = !isVisited(session, "weitere_gemeinsame_kinder"); %><li class='present-perfect<%= unvisited_d58e20 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("weitere_gemeinsame_kinder") != null) { %><span class="item clickable" data-submit-value="resync.weitere_gemeinsame_kinder">
                                    <a href="" class="label">
                                       <span class="labeltext">Weitere (gemeinsame) Kinder</span>
                                       <span class="labelicon" title='<%= unvisited_d58e20 ? "Zurückliegende Seite (nicht besucht)" : "Zurückliegende Seite" %>'>
                                          <span class="accessibility"><%= unvisited_d58e20 ? "Zurückliegende Seite (nicht besucht)" : "Zurückliegende Seite" %></span>
                                       </span>
                                    </a>
                                 </span><% } else { %><span class="item">
                                    <span class="label">
                                 ...
                                 </span><% } %><ul class="icons"><% final boolean unvisited_d58e23 = false; %><li class='present<%= unvisited_d58e23 ? " unvisited" : "" %>'>
                                       <span class="item">
                                          <span class="label">
                                             <span class="labeltext">Weitere (gemeinsame) Kinder</span>
                                             <span class="labelicon" title='<%= unvisited_d58e23 ? "Aktuelle Seite (nicht besucht)" : "Aktuelle Seite" %>'>
                                                <span class="accessibility"><%= unvisited_d58e23 ? "Aktuelle Seite (nicht besucht)" : "Aktuelle Seite" %></span>
                                             </span>
                                          </span>
                                       </span>
                                    </li>
