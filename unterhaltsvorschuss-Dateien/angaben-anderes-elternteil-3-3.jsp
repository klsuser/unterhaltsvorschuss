...
<% pageProcessor.createSyncPoint("angaben-anderes-elternteil-3-3"); %>
<% ((java.util.Set)session.getAttribute("composer.visitedPages")).add("angaben-anderes-elternteil-3-3"); %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cit="http://www.cit.de/ns/jsp" xmlns:html="http://www.w3.org/1999/xhtml" lang="de-DE" class="no-js">
   <head>
    ...
    <cit:theme/>
      ...
      <title id="page-title">
         <cit:conditional test="!assistants.request.valid">Fehler beim Ausfüllen - </cit:conditional>unterhaltsvorschuss - Angaben anderes Elternteil (3/3)</title>
      <cit:control>
         <cit:link rel="helpbase" href="help.jsp"/>
         <cit:flow/>
      </cit:control>
   </head>
   <body id="angaben-anderes-elternteil-3-3">
      <div id="custom_top"/>
      <div id="if">
         <div id="page" class=" has_roadmap_right">
            ...
            <nav id="roadmap" class="roadmap roadmap_right">
               ...
               <ul class="icons"><% final boolean unvisited_d60e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d60e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                     ...
                     </span><% } %></li><% final boolean unvisited_d60e6 = !isVisited(session, "weitere-angaben-antragsteller-in"); %><li class='past<%= unvisited_d60e6 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("weitere-angaben-antragsteller-in") != null) { %><span class="item clickable" data-submit-value="resync.weitere-angaben-antragsteller-in">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d60e8 = !isVisited(session, "angaben-zu-dem-kind-fuer-das-die-leistung-beantragt-wird"); %><li class='past<%= unvisited_d60e8 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-zu-dem-kind-fuer-das-die-leistung-beantragt-wird") != null) { %><span class="item clickable" data-submit-value="resync.angaben-zu-dem-kind-fuer-das-die-leistung-beantragt-wird">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d60e10 = !isVisited(session, "betreuung-des-anderen-elternteiles"); %><li class='past<%= unvisited_d60e10 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("betreuung-des-anderen-elternteiles") != null) { %><span class="item clickable" data-submit-value="resync.betreuung-des-anderen-elternteiles">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d60e16 = !isVisited(session, "angaben-anderes-elternteil-1-3"); %><li class='past<%= unvisited_d60e16 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-anderes-elternteil-1-3") != null) { %><span class="item clickable" data-submit-value="resync.angaben-anderes-elternteil-1-3">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d60e18 = !isVisited(session, "angaben-anderes-elternteil-2-3"); %><li class='past<%= unvisited_d60e18 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-anderes-elternteil-2-3") != null) { %><span class="item clickable" data-submit-value="resync.angaben-anderes-elternteil-2-3">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d60e20 = !isVisited(session, "angaben-anderes-elternteil-3-3"); %><li class='present<%= unvisited_d60e20 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d60e22 = !isVisited(session, "angaben-zum-unterhalt"); %><li class='future<%= unvisited_d60e22 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d60e24 = !isVisited(session, "angaben-zu-weiteren-gemeinsamen-kindern-des-antragstellers-der-antragstellerin"); %><li class='future<%= unvisited_d60e24 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d60e26 = !isVisited(session, "hinweise"); %><li class='future<%= unvisited_d60e26 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  <section id="content" class=" wide">
                     <cit:form beanName="myForm">
                        <div class="wizard-body">
                           <h2 id="title">Angaben anderes Elternteil (3/3)</h2>
                           ...
                           <section class="group narrow">
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "bezugalg") %>' data-live-stay="stay_nonval_d0e2370">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2370" id="stay.nonval.d0e2370" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2370').style.display='none';</script>
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "bezugalgii") %>' data-live-stay="stay_nonval_d0e2400">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2400" id="stay.nonval.d0e2400" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2400').style.display='none';</script>
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "bezugkrankengeld") %>' data-live-stay="stay_nonval_d0e2430">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2430" id="stay.nonval.d0e2430" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2430').style.display='none';</script>
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "bezugrente") %>' data-live-stay="stay_nonval_d0e2460">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2460" id="stay.nonval.d0e2460" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2460').style.display='none';</script>
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "bezugsozialhilfe") %>' data-live-stay="stay_nonval_d0e2490">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2490" id="stay.nonval.d0e2490" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2490').style.display='none';</script>
                           ...
                           <section class="group narrow">
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "einkommenausnebentaetigkeit") %>' data-live-stay="stay_nonval_d0e2559">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2559" id="stay.nonval.d0e2559" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2559').style.display='none';</script>
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "einkommenausvermietung") %>' data-live-stay="stay_nonval_d0e2577">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2577" id="stay.nonval.d0e2577" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2577').style.display='none';</script>
                              ...
                              <section class="block narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "sonstigeseinkommenerlaeuterung") %>'>
                                 ...
                                 <div class="formline">
                                    ...
                                    <aside>
                                       ...
                                       <span id="d0e2604-counter" class="textarea-counter">Noch <span id="sonstigeseinkommenerlaeuterung_remaining">0</span>/400 Zeichen</span>
                                    </aside>
                                    <script type="text/javascript">document.getElementById('d0e2604-counter').style.display='inline';</script>
                                 </div>
                              </section>
                           ...
                           <section class="group narrow">
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "grundbesitz") %>' data-live-stay="stay_nonval_d0e2627">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2627" id="stay.nonval.d0e2627" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2627').style.display='none';</script>
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "kapitallebensversicherung") %>' data-live-stay="stay_nonval_d0e2683">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2683" id="stay.nonval.d0e2683" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2683').style.display='none';</script>
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "sparguthaben") %>' data-live-stay="stay_nonval_d0e2701">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2701" id="stay.nonval.d0e2701" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2701').style.display='none';</script>
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "wertpapiere") %>' data-live-stay="stay_nonval_d0e2719">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2719" id="stay.nonval.d0e2719" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2719').style.display='none';</script>
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "girokonto") %>' data-live-stay="stay_nonval_d0e2737">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2737" id="stay.nonval.d0e2737" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2737').style.display='none';</script>
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "pkw") %>' data-live-stay="stay_nonval_d0e2779">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2779" id="stay.nonval.d0e2779" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2779').style.display='none';</script>
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "vermoegensonstiges") %>' data-live-stay="stay_nonval_d0e2815">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2815" id="stay.nonval.d0e2815" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2815').style.display='none';</script>
                              ...
                              <cit:conditional test="myForm.vermoegensonstiges == true">
                                 <section class="block narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "vermoegensonstigeserlaeuterung") %>'>
                                    ...
                                    <div class="formline">
                                       ...
                                       <aside>
                                          <noscript>Max. 400 Zeichen</noscript>
                                          <span id="d0e2824-counter" class="textarea-counter">Noch <span id="vermoegensonstigeserlaeuterung_remaining">0</span>/400 Zeichen</span>
                                       </aside>
                                       <script type="text/javascript">document.getElementById('d0e2824-counter').style.display='inline';</script>
                                    </div>
                                 </section>
                              </cit:conditional>
                           </section>
                           <section class="group narrow">
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "schwerbehinderung") %>' data-live-stay="stay_nonval_d0e2845">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2845" id="stay.nonval.d0e2845" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2845').style.display='none';</script>
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "behinderungsonstiges") %>' data-live-stay="stay_nonval_d0e2872">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2872" id="stay.nonval.d0e2872" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2872').style.display='none';</script>
                              ...
                              <cit:conditional test="myForm.behinderungsonstiges == true">
                                 <section class="block narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "behinderungsonstigesausfuehrung") %>'>
                                    ...
                                    <div class="formline">
                                       ...
                                       <aside>
                                          <noscript>Max. 400 Zeichen</noscript>
                                          <span id="d0e2881-counter" class="textarea-counter">Noch <span id="behinderungsonstigesausfuehrung_remaining">0</span>/400 Zeichen</span>
                                       </aside>
                                       <script type="text/javascript">document.getElementById('d0e2881-counter').style.display='inline';</script>
                                    </div>
                                 </section>
                              </cit:conditional>
                           </section>
                           ...
                           <section class="group narrow">
                              ...
                              <section class="infobox narrow">Bitte wählen Sie die zutreffenden Punkte aus:<br/><br/></section>
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "schulden") %>' data-live-stay="stay_nonval_d0e2950">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2950" id="stay.nonval.d0e2950" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2950').style.display='none';</script>
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "insolvenzverfahren") %>' data-live-stay="stay_nonval_d0e2977">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2977" id="stay.nonval.d0e2977" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2977').style.display='none';</script>
                              ...
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "vermoegensauskunft") %>' data-live-stay="stay_nonval_d0e2995">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e2995" id="stay.nonval.d0e2995" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e2995').style.display='none';</script>
                              ...
                              <cit:conditional test="myForm.vermoegensauskunft == true">
                                 <section class="block narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "vermoegensauskunfterlaeuterung") %>'>
                                    ...
                                    <div class="formline">
                                       ...
                                       <aside>
                                          <noscript>Max. 400 Zeichen</noscript>
                                          <span id="d0e3004-counter" class="textarea-counter">Noch <span id="vermoegensauskunfterlaeuterung_remaining">0</span>/400 Zeichen</span>
                                       </aside>
                                       <script type="text/javascript">document.getElementById('d0e3004-counter').style.display='inline';</script>
                                    </div>
                                 </section>
                              </cit:conditional>
                              <section class="block live narrow label_after leftalign" data-comments='<%= getComments(pageContext.getAttribute("form"), "keineangaben") %>' data-live-stay="stay_nonval_d0e3013">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e3013" id="stay.nonval.d0e3013" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e3013').style.display='none';</script>
                              ...
                              <cit:conditional test="myForm.keineangaben == true">
                                 <section class="block narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "keineangabenweil") %>'>
                                    ...
                                    <div class="formline">
                                       ...
                                       <aside>
                                          <noscript>Max. 400 Zeichen</noscript>
                                          <span id="d0e3022-counter" class="textarea-counter">Noch <span id="keineangabenweil_remaining">0</span>/400 Zeichen</span>
                                       </aside>
                                       <script type="text/javascript">document.getElementById('d0e3022-counter').style.display='inline';</script>
                                    </div>
                                 </section>
                              </cit:conditional>
                           </section>
                        ...
                        <nav id="roadmap_bottom" class="roadmap">
                           ...
                           <ul class="icons"><% final boolean unvisited_d62e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d62e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d62e4 = !isVisited(session, "angaben-zum-antragsteller-zur-antragstellerin-als-gesetzliche-r-vertreter-in-des-kindes"); %><li class='past<%= unvisited_d62e4 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-zum-antragsteller-zur-antragstellerin-als-gesetzliche-r-vertreter-in-des-kindes") != null) { %><span class="item clickable" data-submit-value="resync.angaben-zum-antragsteller-zur-antragstellerin-als-gesetzliche-r-vertreter-in-des-kindes">
                                    <a href="" class="label">
                                       <span class="labeltext">Angaben zum Antragsteller/zur Antragstellerin als gesetzliche/r Vertreter/in des Kindes</span>
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d62e16 = !isVisited(session, "angaben-anderes-elternteil-1-3"); %><li class='past<%= unvisited_d62e16 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-anderes-elternteil-1-3") != null) { %><span class="item clickable" data-submit-value="resync.angaben-anderes-elternteil-1-3">
                                    <a href="" class="label">
                                       <span class="labeltext">Angaben anderes Elternteil (1/3)</span>
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d62e18 = !isVisited(session, "angaben-anderes-elternteil-2-3"); %><li class='past<%= unvisited_d62e18 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-anderes-elternteil-2-3") != null) { %><span class="item clickable" data-submit-value="resync.angaben-anderes-elternteil-2-3">
                                    <a href="" class="label">
                                       <span class="labeltext">Angaben anderes Elternteil (2/3)</span>
                                       <span class="labelicon" title='<%= unvisited_d62e18 ? "Zurückliegende Seite (nicht besucht)" : "Zurückliegende Seite" %>'>
                                          <span class="accessibility"><%= unvisited_d62e18 ? "Zurückliegende Seite (nicht besucht)" : "Zurückliegende Seite" %></span>
                                       </span>
                                    </a>
                                 </span><% } else { %><span class="item">
                                    <span class="label">
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d62e20 = !isVisited(session, "angaben-anderes-elternteil-3-3"); %><li class='present<%= unvisited_d62e20 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben anderes Elternteil (3/3)</span>
                                       <span class="labelicon" title='<%= unvisited_d62e20 ? "Aktuelle Seite (nicht besucht)" : "Aktuelle Seite" %>'>
                                          <span class="accessibility"><%= unvisited_d62e20 ? "Aktuelle Seite (nicht besucht)" : "Aktuelle Seite" %></span>
                                       </span>
                                    </span>
                                 </span>
