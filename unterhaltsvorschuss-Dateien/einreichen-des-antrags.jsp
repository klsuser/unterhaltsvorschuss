...
<% pageProcessor.createSyncPoint("einreichen-des-antrags"); %>
<% ((java.util.Set)session.getAttribute("composer.visitedPages")).add("einreichen-des-antrags"); %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cit="http://www.cit.de/ns/jsp" xmlns:html="http://www.w3.org/1999/xhtml" lang="de-DE" class="no-js">
  ...
  <!--plugin:ui-rbs2-->
      ...
      <title id="page-title">
         <cit:conditional test="!assistants.request.valid">Fehler beim Ausfüllen - </cit:conditional>unterhaltsvorschuss - Einreichen des Antrags</title>
      <cit:control>
         ...
         <cit:flow>
            ...
            <cit:do action="gosub" href="weitere-angaben-zum-antragsteller-zur-antragstellerin.jsp" scope="antragstellerweitere"/>
            <cit:do action="gosub" href="angaben-zum-kind-fuer-das-die-leistung-beantragt-wird.jsp" scope="kind"/>
            ...
            <cit:do action="gosub" href="angaben-zur-vormundschaft-beistandschaft-und-zum-rechtsbeistand.jsp" scope="vormundschaft"/>
            <cit:do action="gosub" href="angaben-zum-anderen-elternteil-1-3.jsp" scope="andererelternteil1"/>
            <cit:if action="gosub" href="angaben-zum-anderen-elternteil-2-3.jsp" test="myForm.andererelternteil1.ehemannvater == true || myForm.andererelternteil1.vaterschaftanerkannt == true" scope="andererelternteil2"/>
            <cit:if action="gosub" href="angaben-zum-anderen-elternteil-3-3.jsp" test="myForm.andererelternteil1.ehemannvater == true || myForm.andererelternteil1.vaterschaftanerkannt == true" scope="andererelternteil3"/>
            <cit:if action="gosub" href="betreuung-des-anderen-elternteiles.jsp" test="myForm.andererelternteil1.ehemannvater == true || myForm.andererelternteil1.vaterschaftanerkannt == true" scope="betreuung"/>
            <cit:if action="gosub" href="angaben-zum-unterhalt.jsp" test="myForm.andererelternteil1.ehemannvater == true || myForm.andererelternteil1.vaterschaftanerkannt == true" scope="unterhalt"/>
         ...
         <cit:page-validation id="d0e59-required" test="!My.empty(myForm.eid)"/>
      </cit:control>
   </head>
   <body id="einreichen-des-antrags">
      <div id="custom_top"/>
      <div id="if">
         <div id="page" class=" has_roadmap_right">
            ...
            <nav id="roadmap" class="roadmap roadmap_right">
               ...
               <ul class="icons"><% final boolean unvisited_d9e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d9e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                     ...
                     </span><% } %></li><% final boolean unvisited_d9e4 = !isVisited(session, "einreichen-des-antrags"); %><li class='present<%= unvisited_d9e4 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d9e8 = !isVisited(session, "rbs_bez"); %><li class='future<%= unvisited_d9e8 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d9e10 = !isVisited(session, "weitere-angaben-zum-antragsteller-zur-antragstellerin"); %><li class='future<%= unvisited_d9e10 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d9e12 = !isVisited(session, "angaben-zum-kind-fuer-das-die-leistung-beantragt-wird"); %><li class='future<%= unvisited_d9e12 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d9e14 = !isVisited(session, "demnaechst-vollenden-werden"); %><li class='future<%= unvisited_d9e14 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d9e16 = !isVisited(session, "angaben-zur-vormundschaft-beistandschaft-und-zum-rechtsbeistand"); %><li class='future<%= unvisited_d9e16 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d9e18 = !isVisited(session, "angaben-zum-anderen-elternteil-1-3"); %><li class='future<%= unvisited_d9e18 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d9e20 = !isVisited(session, "angaben-zum-anderen-elternteil-2-3"); %><li class='future<%= unvisited_d9e20 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d9e22 = !isVisited(session, "angaben-zum-anderen-elternteil-3-3"); %><li class='future<%= unvisited_d9e22 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d9e24 = !isVisited(session, "betreuung-des-anderen-elternteiles"); %><li class='future<%= unvisited_d9e24 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d9e26 = !isVisited(session, "angaben-zum-unterhalt"); %><li class='future<%= unvisited_d9e26 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d9e28 = !isVisited(session, "angaben-zu-weiteren-gemeinsamen-kindern-des-antragstellers-der-antragstellerin"); %><li class='future<%= unvisited_d9e28 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d9e30 = !isVisited(session, "hinweise"); %><li class='future<%= unvisited_d9e30 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d9e32 = !isVisited(session, "nachweise"); %><li class='future<%= unvisited_d9e32 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                           <span class="labeltext">Nachweise</span>
                           <span class="labelicon" title='<%= unvisited_d9e32 ? "Kommende Seite" : "Kommende Seite (besucht)" %>'>
                              <span class="accessibility"><%= unvisited_d9e32 ? "Kommende Seite" : "Kommende Seite (besucht)" %></span>
                           </span>
                        </span>
                     </span>
                  </li><% final boolean unvisited_d9e34 = !isVisited(session, "schriftformerfordernis"); %><li class='future<%= unvisited_d9e34 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                           <span class="labeltext">Schriftformerfordernis</span>
                           <span class="labelicon" title='<%= unvisited_d9e34 ? "Kommende Seite" : "Kommende Seite (besucht)" %>'>
                              <span class="accessibility"><%= unvisited_d9e34 ? "Kommende Seite" : "Kommende Seite (besucht)" %></span>
                           </span>
                        </span>
                     </span>
                  </li>
                  ...
                  <section id="content" class=" narrow">
                     <cit:form beanName="myForm">
                        <div class="wizard-body">
                           <h2 id="title">Einreichen des Antrags</h2>
                           ...
                           <section class="infobox narrow">
                              <h3>Wichtiger Hinweis zum Einreichen des Antrags</h3><p>Sie können den Antrag vollständig digital einreichen, sollten Sie einen neuen Personalausweis (nPA) besitzen mit eID-Freischaltung.<br/>Sollten Sie über keinen Personalausweis mit den entsprechenden Funktionen verfügen, können Sie den Antrag zwar ebenfalls online einreichen, jedoch müssen Sie am Ende des Antrags eine PDF ausdrucken und diese zusätzlich an die zuständige Behörde postalisch senden.</p></section>
                           <section class="block live narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "eid") %>' data-live-stay="stay_nonval_d0e59">
                              <cit:conditional test="!assistants.request.isValid('eid')">
                                 <p class="errorText v2">
                                    <span class="icon-warning-sign" aria-hidden="true"/>
                                    <strong>
                                       <cit:errorText name="eid"/>
                                    </strong>
                                 </p>
                              </cit:conditional>
                              <cit:errorText name="eid" id="#page-strict">
                              ...
                              <cit:errorText name="eid" id="#page-soft">
                              ...
                              <cit:validationMessage for="d0e59-required">
                                 <cit:conditional test="assistants.request.isValid('eid')">
                                    <p class="errorText v2">
                                       <span class="icon-warning-sign" aria-hidden="true"/>
                                       <strong>
                              ...
                              <div class="label">
                                 <span class="pseudoLabel required">
                                    <span id="d0e59_label">Möchten Sie die eID Ihres nPA nutzen?<span class="required-mark">
                              ...
                              <div class="formline">
                                 <div class="inputcontainer choice-inline" role="group" aria-labelledby='d0e59_label <%= de.cit.jsp.tags.ErrorTextTag.getErrorIDs(request, "eid") %>'>
                                    <cit:choiceGroup type="boolean" name="eid" required="true">
                                       <div class="choice">
                                          <cit:inputChoice value="true" immediate="true"/>
                                          <cit:inputLabel name="eid.true">Ja</cit:inputLabel>
                                       </div>
                                       <div class="choice">
                                          <cit:inputChoice value="false" immediate="true"/>
                                          <cit:inputLabel name="eid.false">Nein</cit:inputLabel>
                                       </div>
                                    </cit:choiceGroup>
                                 </div>
                              </div>
                              <cit:inputSubmit type="stay.nonval.d0e59" id="stay.nonval.d0e59" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                              <script type="text/javascript">document.getElementById('stay_nonval_d0e59').style.display='none';</script>
                              <cit:script>_unmask(myForm, "eid", "boolean");</cit:script>
                           </section>
                           <cit:conditional test="myForm.eid == true">
                              <section class="block narrow label_before" data-comments='<%= getComments(pageContext.getAttribute("form"), "id_feld") %>'>
                                 ...
                                 <div class="formline">
                                    <cit:inputLabel name="id_feld" v="2">
                                       <span id="$$ID$$">ID-Feld:</span>
                                    </cit:inputLabel>
                                    <div class="inputcontainer">
                                       <cit:inputID name="id_feld">
                        ...
                        <nav id="roadmap_bottom" class="roadmap">
                           ...
                           <ul class="icons"><% final boolean unvisited_d11e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d11e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d11e4 = !isVisited(session, "einreichen-des-antrags"); %><li class='present<%= unvisited_d11e4 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Einreichen des Antrags</span>
                              ...
                              </li><% final boolean unvisited_d11e8 = !isVisited(session, "rbs_bez"); %><li class='future<%= unvisited_d11e8 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Anschrift Berlin</span>
                              ...
                              </li><% final boolean unvisited_d11e10 = !isVisited(session, "weitere-angaben-zum-antragsteller-zur-antragstellerin"); %><li class='future<%= unvisited_d11e10 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Weitere Angaben zum Antragsteller/zur Antragstellerin</span>
                              ...
                              </li><% final boolean unvisited_d11e12 = !isVisited(session, "angaben-zum-kind-fuer-das-die-leistung-beantragt-wird"); %><li class='future<%= unvisited_d11e12 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben zum Kind, für das die Leistung beantragt wird</span>
                              ...
                              </li><% final boolean unvisited_d11e14 = !isVisited(session, "demnaechst-vollenden-werden"); %><li class='future<%= unvisited_d11e14 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Ergänzende Angaben für Kinder, die das 12. Lebensjahr vollendet haben, bzw. demnächst vollenden werden</span>
                              ...
                              </li><% final boolean unvisited_d11e16 = !isVisited(session, "angaben-zur-vormundschaft-beistandschaft-und-zum-rechtsbeistand"); %><li class='future<%= unvisited_d11e16 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben zur Vormundschaft, Beistandschaft und zum Rechtsbeistand</span>
                              ...
                              </li><% final boolean unvisited_d11e18 = !isVisited(session, "angaben-zum-anderen-elternteil-1-3"); %><li class='future<%= unvisited_d11e18 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben zum anderen Elternteil (1/3)</span>
                              ...
                              </li><% final boolean unvisited_d11e20 = !isVisited(session, "angaben-zum-anderen-elternteil-2-3"); %><li class='future<%= unvisited_d11e20 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben zum anderen Elternteil (2/3)</span>
                              ...
                              </li><% final boolean unvisited_d11e22 = !isVisited(session, "angaben-zum-anderen-elternteil-3-3"); %><li class='future<%= unvisited_d11e22 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben zum anderen Elternteil (3/3)</span>
                              ...
                              </li><% final boolean unvisited_d11e24 = !isVisited(session, "betreuung-des-anderen-elternteiles"); %><li class='future<%= unvisited_d11e24 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Betreuung des anderen Elternteiles</span>
                              ...
                              </li><% final boolean unvisited_d11e26 = !isVisited(session, "angaben-zum-unterhalt"); %><li class='future<%= unvisited_d11e26 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben zum Unterhalt</span>
                              ...
                              </li><% final boolean unvisited_d11e28 = !isVisited(session, "angaben-zu-weiteren-gemeinsamen-kindern-des-antragstellers-der-antragstellerin"); %><li class='future<%= unvisited_d11e28 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben zu weiteren (gemeinsamen) Kindern des Antragstellers / der Antragstellerin</span>
                              ...
                              </li><% final boolean unvisited_d11e30 = !isVisited(session, "hinweise"); %><li class='future<%= unvisited_d11e30 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Hinweise</span>
                              ...
                              </li><% final boolean unvisited_d11e32 = !isVisited(session, "nachweise"); %><li class='future<%= unvisited_d11e32 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Nachweise</span>
                                       <span class="labelicon" title='<%= unvisited_d11e32 ? "Kommende Seite" : "Kommende Seite (besucht)" %>'>
                                          <span class="accessibility"><%= unvisited_d11e32 ? "Kommende Seite" : "Kommende Seite (besucht)" %></span>
                                       </span>
                                    </span>
                                 </span>
                              </li><% final boolean unvisited_d11e34 = !isVisited(session, "schriftformerfordernis"); %><li class='future<%= unvisited_d11e34 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Schriftformerfordernis</span>
                                       <span class="labelicon" title='<%= unvisited_d11e34 ? "Kommende Seite" : "Kommende Seite (besucht)" %>'>
                                          <span class="accessibility"><%= unvisited_d11e34 ? "Kommende Seite" : "Kommende Seite (besucht)" %></span>
                                       </span>
                                    </span>
                                 </span>
                              </li>
