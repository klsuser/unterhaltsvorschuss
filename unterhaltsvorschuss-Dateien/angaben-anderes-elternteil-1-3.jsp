...
<% pageProcessor.createSyncPoint("angaben-anderes-elternteil-1-3"); %>
<% ((java.util.Set)session.getAttribute("composer.visitedPages")).add("angaben-anderes-elternteil-1-3"); %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cit="http://www.cit.de/ns/jsp" xmlns:html="http://www.w3.org/1999/xhtml" lang="de-DE" class="no-js">
   <head>
    ...
    <cit:theme/>
      ...
      <title id="page-title">
         <cit:conditional test="!assistants.request.valid">Fehler beim Ausfüllen - </cit:conditional>unterhaltsvorschuss - Angaben anderes Elternteil (1/3)</title>
      <cit:control>
         <cit:link rel="helpbase" href="help.jsp"/>
         <cit:flow/>
      </cit:control>
   </head>
   <body id="angaben-anderes-elternteil-1-3">
      <div id="custom_top"/>
      <div id="if">
         <div id="page" class=" has_roadmap_right">
            ...
            <nav id="roadmap" class="roadmap roadmap_right">
               ...
               <ul class="icons"><% final boolean unvisited_d48e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d48e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                     ...
                     </span><% } %></li><% final boolean unvisited_d48e6 = !isVisited(session, "weitere-angaben-antragsteller-in"); %><li class='past<%= unvisited_d48e6 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("weitere-angaben-antragsteller-in") != null) { %><span class="item clickable" data-submit-value="resync.weitere-angaben-antragsteller-in">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d48e8 = !isVisited(session, "angaben-zu-dem-kind-fuer-das-die-leistung-beantragt-wird"); %><li class='past<%= unvisited_d48e8 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-zu-dem-kind-fuer-das-die-leistung-beantragt-wird") != null) { %><span class="item clickable" data-submit-value="resync.angaben-zu-dem-kind-fuer-das-die-leistung-beantragt-wird">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d48e10 = !isVisited(session, "betreuung-des-anderen-elternteiles"); %><li class='past<%= unvisited_d48e10 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("betreuung-des-anderen-elternteiles") != null) { %><span class="item clickable" data-submit-value="resync.betreuung-des-anderen-elternteiles">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d48e12 = !isVisited(session, "demnaechst-vollenden-werden"); %><li class='past<%= unvisited_d48e12 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("demnaechst-vollenden-werden") != null) { %><span class="item clickable" data-submit-value="resync.demnaechst-vollenden-werden">
                        <a href="" class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d48e14 = !isVisited(session, "vormundschaft-beistandschaft-rechtsbeistand"); %><li class='past<%= unvisited_d48e14 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("vormundschaft-beistandschaft-rechtsbeistand") != null) { %><span class="item clickable" data-submit-value="resync.vormundschaft-beistandschaft-rechtsbeistand">
                        <a href="" class="label">
                           <span class="labeltext">Vormundschaft / Beistandschaft / Rechtsbeistand</span>
                           <span class="labelicon" title='<%= unvisited_d48e14 ? "Zurückliegende Seite (nicht besucht)" : "Zurückliegende Seite" %>'>
                              <span class="accessibility"><%= unvisited_d48e14 ? "Zurückliegende Seite (nicht besucht)" : "Zurückliegende Seite" %></span>
                           </span>
                        </a>
                     </span><% } else { %><span class="item">
                        <span class="label">
                     ...
                     </span><% } %></li><% final boolean unvisited_d48e16 = !isVisited(session, "angaben-anderes-elternteil-1-3"); %><li class='present<%= unvisited_d48e16 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                           <span class="labeltext">Angaben anderes Elternteil (1/3)</span>
                           <span class="labelicon" title='<%= unvisited_d48e16 ? "Aktuelle Seite (nicht besucht)" : "Aktuelle Seite" %>'>
                              <span class="accessibility"><%= unvisited_d48e16 ? "Aktuelle Seite (nicht besucht)" : "Aktuelle Seite" %></span>
                           </span>
                        </span>
                     </span>
                  </li><% final boolean unvisited_d48e18 = !isVisited(session, "angaben-anderes-elternteil-2-3"); %><li class='future<%= unvisited_d48e18 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d48e20 = !isVisited(session, "angaben-anderes-elternteil-3-3"); %><li class='future<%= unvisited_d48e20 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d48e22 = !isVisited(session, "angaben-zum-unterhalt"); %><li class='future<%= unvisited_d48e22 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d48e24 = !isVisited(session, "angaben-zu-weiteren-gemeinsamen-kindern-des-antragstellers-der-antragstellerin"); %><li class='future<%= unvisited_d48e24 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d48e26 = !isVisited(session, "hinweise"); %><li class='future<%= unvisited_d48e26 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  <section id="content" class=" narrow">
                     <cit:form beanName="myForm">
                        <div class="wizard-body">
                           <h2 id="title">Angaben anderes Elternteil (1/3)</h2>
                           ...
                           <section class="group narrow">
                              ...
                              <section class="block live narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "kindehelich") %>' data-live-stay="stay_nonval_d0e1757">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e1757" id="stay.nonval.d0e1757" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e1757').style.display='none';</script>
                                 <cit:script>_unmask(myForm, "kindehelich", "string");</cit:script>
                              </section>
                              <cit:conditional test="myForm.kindehelich === &#34;Ja&#34;">
                                 <section class="block live narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "ehemannnichtvater") %>' data-live-stay="stay_nonval_d0e1775">
                                    ...
                                    <cit:inputSubmit type="stay.nonval.d0e1775" id="stay.nonval.d0e1775" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                    <script type="text/javascript">document.getElementById('stay_nonval_d0e1775').style.display='none';</script>
                              ...
                              <cit:conditional test="myForm.ehemannnichtvater == true || myForm.ehemannnichtvater == false">
                                 <section class="block live narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "vaterschaftsanfechtungsklage") %>' data-live-stay="stay_nonval_d0e1793">
                                    ...
                                    <cit:inputSubmit type="stay.nonval.d0e1793" id="stay.nonval.d0e1793" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                    <script type="text/javascript">document.getElementById('stay_nonval_d0e1793').style.display='none';</script>
                              ...
                              <cit:conditional test="myForm.kindehelich == &#34;Nein&#34;">
                                 <section class="block live narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "vaterschaftanerkannt") %>' data-live-stay="stay_nonval_d0e1814">
                                    ...
                                    <cit:inputSubmit type="stay.nonval.d0e1814" id="stay.nonval.d0e1814" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                    <script type="text/javascript">document.getElementById('stay_nonval_d0e1814').style.display='none';</script>
                              ...
                              <cit:conditional test="myForm.vaterschaftanerkannt == false">
                                 <section class="block live narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "antragauffeststellungvaterschaft") %>' data-live-stay="stay_nonval_d0e1832">
                                    ...
                                    <cit:inputSubmit type="stay.nonval.d0e1832" id="stay.nonval.d0e1832" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                    <script type="text/javascript">document.getElementById('stay_nonval_d0e1832').style.display='none';</script>
                                 ...
                                 <section class="block narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "vaterschaftnochnichtfestgestelltweil") %>'>
                                    ...
                                    <div class="formline">
                                       ...
                                       <aside>
                                          ...
                                          <span id="d0e1850-counter" class="textarea-counter">Noch <span id="vaterschaftnochnichtfestgestelltweil_remaining">0</span>/400 Zeichen</span>
                                       </aside>
                                       <script type="text/javascript">document.getElementById('d0e1850-counter').style.display='inline';</script>
                                    </div>
                                 </section>
                              </cit:conditional>
                              <cit:conditional test="myForm.kindehelich == &#34;Vaterschaft nicht feststellbar&#34;">
                                 <section class="block narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "vaterschaftnichtfeststellbarweil") %>'>
                                    ...
                                    <div class="formline">
                                       ...
                                       <aside>
                                          <noscript>Max. 400 Zeichen</noscript>
                                          <span id="d0e1859-counter" class="textarea-counter">Noch <span id="vaterschaftnichtfeststellbarweil_remaining">0</span>/400 Zeichen</span>
                                       </aside>
                                       <script type="text/javascript">document.getElementById('d0e1859-counter').style.display='inline';</script>
                                    </div>
                                 </section>
                              </cit:conditional>
                           </section>
                           <section class="group narrow">
                              <header>
                                 <h3>Angaben anderes Elternteil</h3>
                              </header>
                        ...
                        <nav id="roadmap_bottom" class="roadmap">
                           ...
                           <ul class="icons"><% final boolean unvisited_d51e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d51e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d51e4 = !isVisited(session, "angaben-zum-antragsteller-zur-antragstellerin-als-gesetzliche-r-vertreter-in-des-kindes"); %><li class='past<%= unvisited_d51e4 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("angaben-zum-antragsteller-zur-antragstellerin-als-gesetzliche-r-vertreter-in-des-kindes") != null) { %><span class="item clickable" data-submit-value="resync.angaben-zum-antragsteller-zur-antragstellerin-als-gesetzliche-r-vertreter-in-des-kindes">
                                    <a href="" class="label">
                                       <span class="labeltext">Angaben zum Antragsteller/zur Antragstellerin als gesetzliche/r Vertreter/in des Kindes</span>
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d51e6 = !isVisited(session, "weitere-angaben-antragsteller-in"); %><li class='past<%= unvisited_d51e6 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("weitere-angaben-antragsteller-in") != null) { %><span class="item clickable" data-submit-value="resync.weitere-angaben-antragsteller-in">
                                    <a href="" class="label">
                                       <span class="labeltext">Weitere Angaben Antragsteller/in</span>
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d51e14 = !isVisited(session, "vormundschaft-beistandschaft-rechtsbeistand"); %><li class='past<%= unvisited_d51e14 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("vormundschaft-beistandschaft-rechtsbeistand") != null) { %><span class="item clickable" data-submit-value="resync.vormundschaft-beistandschaft-rechtsbeistand">
                                    <a href="" class="label">
                                       <span class="labeltext">Vormundschaft / Beistandschaft / Rechtsbeistand</span>
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d51e16 = !isVisited(session, "angaben-anderes-elternteil-1-3"); %><li class='present<%= unvisited_d51e16 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben anderes Elternteil (1/3)</span>
                              ...
                              </li><% final boolean unvisited_d51e18 = !isVisited(session, "angaben-anderes-elternteil-2-3"); %><li class='future<%= unvisited_d51e18 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben anderes Elternteil (2/3)</span>
                              ...
                              </li><% final boolean unvisited_d51e20 = !isVisited(session, "angaben-anderes-elternteil-3-3"); %><li class='future<%= unvisited_d51e20 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben anderes Elternteil (3/3)</span>
                              ...
                              </li><% final boolean unvisited_d51e22 = !isVisited(session, "angaben-zum-unterhalt"); %><li class='future<%= unvisited_d51e22 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben zum Unterhalt</span>
                              ...
                              </li><% final boolean unvisited_d51e24 = !isVisited(session, "angaben-zu-weiteren-gemeinsamen-kindern-des-antragstellers-der-antragstellerin"); %><li class='future<%= unvisited_d51e24 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben zu weiteren (gemeinsamen) Kindern des Antragstellers / der Antragstellerin</span>
                              ...
                              </li><% final boolean unvisited_d51e26 = !isVisited(session, "hinweise"); %><li class='future<%= unvisited_d51e26 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Hinweise</span>
