...
<% pageProcessor.createSyncPoint("sonstige-angaben"); %>
<% ((java.util.Set)session.getAttribute("composer.visitedPages")).add("sonstige-angaben"); %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cit="http://www.cit.de/ns/jsp" xmlns:html="http://www.w3.org/1999/xhtml" lang="de-DE" class="no-js">
   <head>
    ...
    <cit:theme/>
      ...
      <title id="page-title">
         <cit:conditional test="!assistants.request.valid">Fehler beim Ausfüllen - </cit:conditional>unterhaltsvorschuss - Sonstige Angaben</title>
      <cit:control>
         <cit:link rel="helpbase" href="help.jsp"/>
         <cit:flow/>
      </cit:control>
   </head>
   <body id="sonstige-angaben">
      <div id="custom_top"/>
      <div id="if">
         <div id="page" class=" has_roadmap_right">
            ...
            <nav id="roadmap" class="roadmap roadmap_right">
               ...
               <ul class="icons"><% final boolean unvisited_d42e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d42e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                     ...
                     </span><% } %></li><% final boolean unvisited_d42e16 = !isVisited(session, "sonstige-angaben"); %><li class='present<%= unvisited_d42e16 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                           <span class="labeltext">Sonstige Angaben</span>
                  ...
                  <section id="content" class=" narrow">
                     <cit:form beanName="myForm">
                        <div class="wizard-body">
                           <h2 id="title">Sonstige Angaben</h2>
                           ...
                           <section class="block narrow label_above" data-comments='<%= getComments(pageContext.getAttribute("form"), "sonstigeangaben") %>'>
                              <cit:conditional test="!assistants.request.isValid('sonstigeangaben')">
                                 <p class="errorText">
                                    <strong>
                                       <cit:errorText name="sonstigeangaben"/>
                                    </strong>
                                 </p>
                              </cit:conditional>
                              <cit:errorText name="sonstigeangaben" id="#page-strict">
                                 <p class="errorText">
                                    <strong>Bitte Eingabe bzw. Auswahl prüfen.</strong>
                                 </p>
                              </cit:errorText>
                              <cit:errorText name="sonstigeangaben" id="#page-soft">
                                 <p class="errorText loose">
                                    <strong>Bitte Eingabe bzw. Auswahl prüfen.</strong>
                                 </p>
                              </cit:errorText>
                              <div class="label">
                                 <span class="pseudoLabel">Bitte wählen Sie die zutreffenden Punkte aus:</span>
                              </div>
                              <div class="formline">
                                 <div class="inputcontainer">
                                    <cit:inputSelectMultiple name="sonstigeangaben">
                                       <cit:option value="Schulden">Schulden</cit:option>
                                       <cit:option value="Insolvenzverfahren eröffnet/beantragt">Insolvenzverfahren eröffnet/beantragt</cit:option>
                                       <cit:option value="Vermögensauskunft (früher: eidesstattliche Versicherung) wurde bereits abgegeben">Vermögensauskunft (früher: eidesstattliche Versicherung) wurde bereits abgegeben</cit:option>
                                       <cit:option value="Ich kann keine Angaben machen">Ich kann keine Angaben machen</cit:option>
                        ...
                        <nav id="roadmap_bottom" class="roadmap">
                           ...
                           <ul class="icons"><% final boolean unvisited_d44e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d44e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d44e16 = !isVisited(session, "sonstige-angaben"); %><li class='present<%= unvisited_d44e16 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Sonstige Angaben</span>
