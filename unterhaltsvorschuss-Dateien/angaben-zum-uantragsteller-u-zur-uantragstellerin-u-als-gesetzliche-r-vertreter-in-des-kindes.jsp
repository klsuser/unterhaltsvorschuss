...
<% pageProcessor.createSyncPoint("angaben-zum-uantragsteller-u-zur-uantragstellerin-u-als-gesetzliche-r-vertreter-in-des-kindes"); %>
<% ((java.util.Set)session.getAttribute("composer.visitedPages")).add("angaben-zum-uantragsteller-u-zur-uantragstellerin-u-als-gesetzliche-r-vertreter-in-des-kindes"); %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cit="http://www.cit.de/ns/jsp" xmlns:html="http://www.w3.org/1999/xhtml" lang="de-DE" class="no-js">
   <head>
    ...
    <cit:theme/>
      ...
      <title id="page-title">
         <cit:conditional test="!assistants.request.valid">Fehler beim Ausfüllen - </cit:conditional>unterhaltsvorschuss - Angaben zum &lt;u&gt;Antragsteller&lt;/u&gt;/zur &lt;u&gt;Antragstellerin&lt;/u&gt; als gesetzliche/r Vertreter/in des Kindes</title>
      <cit:control>
         <cit:link rel="helpbase" href="help.jsp"/>
         <cit:flow/>
      </cit:control>
   </head>
   <body id="angaben-zum-uantragsteller-u-zur-uantragstellerin-u-als-gesetzliche-r-vertreter-in-des-kindes">
      <div id="custom_top"/>
      <div id="if">
         <div id="page" class=" has_roadmap_right">
            ...
            <nav id="roadmap" class="roadmap roadmap_right">
               ...
               <ul class="icons"><% final boolean unvisited_d9e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d9e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                     ...
                     </span><% } %></li><% final boolean unvisited_d9e4 = !isVisited(session, "angaben-zum-uantragsteller-u-zur-uantragstellerin-u-als-gesetzliche-r-vertreter-in-des-kindes"); %><li class='present<%= unvisited_d9e4 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                           <span class="labeltext">Angaben zum &lt;u&gt;Antragsteller&lt;/u&gt;/zur &lt;u&gt;Antragstellerin&lt;/u&gt; als gesetzliche/r Vertreter/in des Kindes</span>
                  ...
                  <section id="content" class=" narrow">
                     <cit:form beanName="myForm">
                        <div class="wizard-body">
                           <h2 id="title">Angaben zum &lt;u&gt;Antragsteller&lt;/u&gt;/zur &lt;u&gt;Antragstellerin&lt;/u&gt; als gesetzliche/r Vertreter/in des Kindes</h2>
                        ...
                        <nav id="roadmap_bottom" class="roadmap">
                           ...
                           <ul class="icons"><% final boolean unvisited_d13e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d13e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d13e4 = !isVisited(session, "angaben-zum-uantragsteller-u-zur-uantragstellerin-u-als-gesetzliche-r-vertreter-in-des-kindes"); %><li class='present<%= unvisited_d13e4 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben zum &lt;u&gt;Antragsteller&lt;/u&gt;/zur &lt;u&gt;Antragstellerin&lt;/u&gt; als gesetzliche/r Vertreter/in des Kindes</span>
