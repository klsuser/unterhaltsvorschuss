...
_b.AutoSuggest = function (id, param)
{
	...
	//this.fld.onfocus 		= function(ev){ return p.onFocus(ev); };	310120
	this.fld.addEventListener('keydown', function(ev){ return p.onKeyDown(ev); });
	//this.fld.onkeydown 	= function(ev){ return p.onKeyDown(ev); };
	this.fld.addEventListener('keyup', function(ev){ return p.onKeyUp(ev); });
