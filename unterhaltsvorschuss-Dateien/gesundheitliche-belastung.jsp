...
<% pageProcessor.createSyncPoint("gesundheitliche-belastung"); %>
<% ((java.util.Set)session.getAttribute("composer.visitedPages")).add("gesundheitliche-belastung"); %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cit="http://www.cit.de/ns/jsp" xmlns:html="http://www.w3.org/1999/xhtml" lang="de-DE" class="no-js">
   <head>
    ...
    <cit:theme/>
      ...
      <title id="page-title">
         <cit:conditional test="!assistants.request.valid">Fehler beim Ausfüllen - </cit:conditional>unterhaltsvorschuss - Gesundheitliche Belastung</title>
      <cit:control>
         <cit:link rel="helpbase" href="help.jsp"/>
         <cit:flow/>
      </cit:control>
   </head>
   <body id="gesundheitliche-belastung">
      <div id="custom_top"/>
      <div id="if">
         <div id="page" class=" has_roadmap_right">
            ...
            <nav id="roadmap" class="roadmap roadmap_right">
               ...
               <ul class="icons"><% final boolean unvisited_d42e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d42e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                     ...
                     </span><% } %></li><% final boolean unvisited_d42e16 = !isVisited(session, "gesundheitliche-belastung"); %><li class='present<%= unvisited_d42e16 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                           <span class="labeltext">Gesundheitliche Belastung</span>
                  ...
                  <section id="content" class=" narrow">
                     <cit:form beanName="myForm">
                        <div class="wizard-body">
                           <h2 id="title">Gesundheitliche Belastung</h2>
                           ...
                           <section class="block live narrow label_after" data-comments='<%= getComments(pageContext.getAttribute("form"), "schwerbehinderung") %>' data-live-stay="stay_nonval_d0e2059">
                              ...
                              <cit:inputSubmit type="stay.nonval.d0e2059" id="stay.nonval.d0e2059" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                              <script type="text/javascript">document.getElementById('stay_nonval_d0e2059').style.display='none';</script>
                           ...
                           <section class="block live narrow label_after" data-comments='<%= getComments(pageContext.getAttribute("form"), "behinderungsonstiges") %>' data-live-stay="stay_nonval_d0e2086">
                        ...
                        <nav id="roadmap_bottom" class="roadmap">
                           ...
                           <ul class="icons"><% final boolean unvisited_d44e2 = !isVisited(session, "datenschutzhinweis"); %><li class='past<%= unvisited_d44e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("datenschutzhinweis") != null) { %><span class="item clickable" data-submit-value="resync.datenschutzhinweis">
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d44e16 = !isVisited(session, "gesundheitliche-belastung"); %><li class='present<%= unvisited_d44e16 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Gesundheitliche Belastung</span>
